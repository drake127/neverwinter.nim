...
public:
	...
	//
	//          FALSE:  No entry point is required. Scripts without an entry
	//              point are validated (syntax and semantics) but no code
	//              is generated. Useful for validating include files.
	//
	///////////////////////////////////////////////////////////////////////
